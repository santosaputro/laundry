...
<html lang="en">
  <head>
    ...
    <title>SCL - Simple Clean Laundry</title>
    ...
    <!-- styling -->
    <link rel="stylesheet" href="<?php echo base_url('assets/css/style1.css') ?>" crossorigin="anonymous">
  ...
  <body>
    ...
    <?php
      // Header
      $this->load->view('theme/home/header');
      // main content
